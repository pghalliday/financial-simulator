...
import {PAGE_TITLE} from "~/page_params/PageParams";
...
export default function CompareScenarios() {
    ...
    const pageDescription = COMPARE_SCENARIOS_NAVBAR_LINK_TREE.navbarLinkLabel;
    const pageTitle = PAGE_TITLE(pageDescription)
    const pageBreadcrumbs = [
        {
            title: pageDescription,
            href: COMPARE_SCENARIOS_NAVBAR_LINK_TREE.navbarLinkHref,
        },
    ]
