...
import type { GetScenarioScenariosScenarioIdGetData, GetScenarioScenariosScenarioIdGetErrors, GetScenarioScenariosScenarioIdGetResponses, GetScenariosScenariosGetData, GetScenariosScenariosGetErrors, GetScenariosScenariosGetResponses, PatchScenarioScenariosScenarioIdPatchData, PatchScenarioScenariosScenarioIdPatchErrors, PatchScenarioScenariosScenarioIdPatchResponses, PatchScenarioScenariosScenarioIdPutData, PatchScenarioScenariosScenarioIdPutErrors, PatchScenarioScenariosScenarioIdPutResponses, PostScenarioScenariosPostData, PostScenarioScenariosPostErrors, PostScenarioScenariosPostResponses } from './types.gen';
 ...
 * Patch Scenario
 */
export const patchScenarioScenariosScenarioIdPut = <ThrowOnError extends boolean = false>(options: Options<PatchScenarioScenariosScenarioIdPutData, ThrowOnError>) => {
    return (options.client ?? client).put<PatchScenarioScenariosScenarioIdPutResponses, PatchScenarioScenariosScenarioIdPutErrors, ThrowOnError>({
        url: '/scenarios/{scenario_id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
