...
import {AddDailyScheduleModal} from "~/modals/AddItemModal/schedules/AddDailyScheduleModal";
...
const NAME_COLUMN: Column<DailyScheduleGet> = {
    heading: "Name",
    hasLink: true,
...
const DESCRIPTION_COLUMN: Column<DailyScheduleGet> = {
    heading: "Description",
    hasLink: false,
...
const DEFAULT_SORT_BY: SortBy<DailyScheduleGet>[] = [{
    column: NAME_COLUMN,
    reversed: false,
}, {
...
export function DailyScheduleList(
    ...
    const onDelete = useCallback((item: DailyScheduleGet) => {
        setToDelete(item)
        setConfirmDeletePrompt(DAILY_SCHEDULE_PARAMS.confirmDeleteItemModalPrompt(item))
    ...
    return <>
        <Modal.Stack>
            ...
            <ConfirmDeleteModal
                ...
                title={DAILY_SCHEDULE_PARAMS.confirmDeleteItemModalTitle}
