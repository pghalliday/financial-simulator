...
import {AddBankAccountModal} from "~/modals/AddItemModal/bank_accounts/AddBankAccountModal";
...
export function BankAccountList(
    ...
    const {setToDelete, deleteItem} = useListDelete<BankAccountGet>({
        items: bankAccounts,
    ...
    const onDelete = useCallback((item: BankAccountGet) => {
        setToDelete(item)
        setConfirmDeletePrompt(BANK_ACCOUNT_PARAMS.confirmDeleteItemModalPrompt(item))
    ...
    return <>
        <Modal.Stack>
            ...
            <ConfirmDeleteModal
                ...
                title={BANK_ACCOUNT_PARAMS.confirmDeleteItemModalTitle}
        ...
        <SearchSortList
            columns={COLUMNS}
            items={bankAccounts}
            getItemPageParams={BANK_ACCOUNT_PARAMS.getItemPageParams}
            href={BANK_ACCOUNT_PARAMS.itemHref}
            onAdd={onAdd}
            onDelete={onDelete}
