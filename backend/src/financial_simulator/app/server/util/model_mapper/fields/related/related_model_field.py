...
from financial_simulator.app.server.util.model_mapper.fields.related.related_patch_field import RelatedPatchField
...
class RelatedModelField(ModelField[TABLE, GET, POST]):
    def __init__(self, field_relation: FieldRelation) -> None:
        super().__init__(
            ...
            patch_field=RelatedPatchField[TABLE](field_relation),
        )
