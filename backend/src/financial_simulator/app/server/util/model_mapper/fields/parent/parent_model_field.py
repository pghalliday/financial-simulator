...
from financial_simulator.app.server.util.model_mapper.fields.parent.parent_get_field import ParentGetField
...
class ParentModelField(ModelField[TABLE, POST, GET], Generic[TABLE, POST, GET, RELATED_TABLE, RELATED_GET]):
    def __init__(self, get_mapper: GetMapperInterface[RELATED_TABLE, RELATED_GET] = None) -> None:
        super().__init__(
