...
from financial_simulator.app.server.util.model_mapper.fields.ordinary.ordinary_patch_field import OrdinaryPatchField
...
class OrdinaryModelField(ModelField[TABLE, GET, POST]):
    def __init__(self) -> None:
        super().__init__(
            ...
            patch_field=OrdinaryPatchField[TABLE](),
        )
