...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id"], ["rate.id"], name=op.f("fk_banded_rate_id_rate")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["asset_account"],
            ["ledger_account.id"],
            name=op.f("fk_bank_account_asset_account_ledger_account"),
        ),
        sa.ForeignKeyConstraint(
            ["fee_expenses_account"],
            ["ledger_account.id"],
            name=op.f("fk_bank_account_fee_expenses_account_ledger_account"),
        ),
        sa.ForeignKeyConstraint(
            ["fee_payment_schedule_id"],
            ["schedule.id"],
            name=op.f("fk_bank_account_fee_payment_schedule_id_schedule"),
        ),
        sa.ForeignKeyConstraint(
            ["fees_payable_account"],
            ["ledger_account.id"],
            name=op.f("fk_bank_account_fees_payable_account_ledger_account"),
        ),
        sa.ForeignKeyConstraint(
            ["fees_provider_id"],
            ["provider.id"],
            name=op.f("fk_bank_account_fees_provider_id_provider"),
        ),
        sa.ForeignKeyConstraint(
            ["interest_income_account"],
            ["ledger_account.id"],
            name=op.f("fk_bank_account_interest_income_account_ledger_account"),
        ),
        sa.ForeignKeyConstraint(
            ["interest_payment_schedule_id"],
            ["schedule.id"],
            name=op.f("fk_bank_account_interest_payment_schedule_id_schedule"),
        ),
        sa.ForeignKeyConstraint(
            ["interest_receivable_account"],
            ["ledger_account.id"],
            name=op.f("fk_bank_account_interest_receivable_account_ledger_account"),
        ),
        sa.ForeignKeyConstraint(
            ["rate_provider_id"],
            ["provider.id"],
            name=op.f("fk_bank_account_rate_provider_id_provider"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id"], ["rate.id"], name=op.f("fk_continuous_rate_id_rate")
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.ForeignKeyConstraint(
            ["id"], ["entity.id"], name=op.f("fk_corporation_entity_id_entity")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id"], ["value.id"], name=op.f("fk_decimal_value_id_value")
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.ForeignKeyConstraint(
            ["id"], ["entity.id"], name=op.f("fk_individual_entity_id_entity")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_individual_entity")),
    )
    op.create_table(
        "ledger_account_component",
        ...
        sa.ForeignKeyConstraint(
            ["ledger_account_id"],
            ["ledger_account.id"],
            name=op.f("fk_ledger_account_component_ledger_account_id_ledger_account"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id"], ["rate.id"], name=op.f("fk_periodic_rate_id_rate")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id"], ["value.id"], name=op.f("fk_rate_value_id_value")
        ),
        sa.ForeignKeyConstraint(
            ["rate_id"], ["rate.id"], name=op.f("fk_rate_value_rate_id_rate")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["banded_rate_id"],
            ["banded_rate.id"],
            name=op.f("fk_banded_rate_band_banded_rate_id_banded_rate"),
        ),
        sa.ForeignKeyConstraint(
            ["rate_id"], ["rate.id"], name=op.f("fk_banded_rate_band_rate_id_rate")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_banded_rate_band")),
    )
    op.create_table(
        "corporation_entity_bank_account",
        ...
        sa.ForeignKeyConstraint(
            ...
            ["bank_account.id"],
            name=op.f(
                "fk_corporation_entity_bank_account_bank_account_id_bank_account"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["corporation_entity_id"],
            ["corporation_entity.id"],
            name=op.f(
                "fk_corporation_entity_bank_account_corporation_entity_id_corporation_entity"
            ),
        ),
        sa.PrimaryKeyConstraint(
            "corporation_entity_id",
            "bank_account_id",
            name=op.f("pk_corporation_entity_bank_account"),
        ),
    )
    op.create_table(
        "individual_entity_bank_account",
        sa.Column("individual_entity_id", sa.Uuid(), nullable=False),
        sa.Column("bank_account_id", sa.Uuid(), nullable=False),
        sa.ForeignKeyConstraint(
            ["bank_account_id"],
            ["bank_account.id"],
            name=op.f("fk_individual_entity_bank_account_bank_account_id_bank_account"),
        ),
        sa.ForeignKeyConstraint(
            ["individual_entity_id"],
            ["individual_entity.id"],
            name=op.f(
                "fk_individual_entity_bank_account_individual_entity_id_individual_entity"
            ),
        ),
        sa.PrimaryKeyConstraint(
            "individual_entity_id",
            "bank_account_id",
            name=op.f("pk_individual_entity_bank_account"),
        ),
    )
