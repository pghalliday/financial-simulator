...
Revision ID: 8d7fc4d2b19d
Revises: 
Create Date: 2025-10-11 13:11:24.547121
...
def upgrade() -> None:
    ...
    sa.Column('interest_income_account_id', sa.Uuid(), nullable=False),
    sa.Column('interest_receivable_account_id', sa.Uuid(), nullable=False),
    sa.Column('fee_expenses_account_id', sa.Uuid(), nullable=False),
    sa.Column('fees_payable_account_id', sa.Uuid(), nullable=False),
