...
from financial_simulator.lib.entities import Corporation, Individual
    ...
    books=Books.create(
        Transaction(
            ...
            changes=(
                ...
                Change(
                    amount=Decimal("5100.0"), account_path=("liabilities", "equity")
                ),
            ),
        )
    ),
    ...
    books=Books.create(
        Transaction(
            ...
            changes=(
                ...
                Change(
                    amount=Decimal("3200.0"), account_path=("liabilities", "equity")
                ),
            ),
        )
    ),
