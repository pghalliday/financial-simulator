...
from financial_simulator.encryption import write
from financial_simulator.passphrase import get_passphrase, confirm_passphrase
...
def encrypt(args: Namespace, config: Config):
    ...
    write(encrypted_file=config.encryption.encrypted_sqlite_file,
...
def add_encrypt_command(subparsers):
